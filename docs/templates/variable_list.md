...
| `languages`                   | **Description:** Controls which Languages will be active.<br>**Default:** `["en", "de", "fr", "es", "pt", "ja"]` <br>**Values:** List of [ISO 639-1 Codes](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) or [ISO 639-2 Codes](https://en.wikipedia.org/wiki/List_of_ISO_639-2_codes) for the Languages desired                                                                                   |
